...
Widget _iconstab() {
  return Container(
    ...
    child: Row(
      ...
      children: [
        IconButton(
         icon: Icon(Icons.picture_in_picture, size: 30.0, color: Colors.blue,),
          onPressed: () {}
           ),
        IconButton(
          icon: Icon(Icons.play_arrow, size: 30.0, color: Colors.blue,),
          onPressed: () {}
          ),
        IconButton(
          icon: Icon(Icons.data_saver_on, size: 30.0, color: Colors.blue,),
          onPressed: () {}
            , )
      ],
  ...
  return Container(
    child: ClipRRect(
      ...
      child: Image(
        ...
        height: 500,
        fit: BoxFit.cover,
        image: NetworkImage("https://d20f60vzbd93dl.cloudfront.net/uploads/tienda_010118/tienda_010118_7c8710ede5bef3ec0f3ea79028d6537a5d50f372_producto_large_90.jpg"),
      ),
    )
  );
}
  ...
  return Container(
      child: ClipRRect(
        ...
        child: Image(
          ...
          height: 500,
          fit: BoxFit.cover,
          image: NetworkImage("https://2.bp.blogspot.com/-wpw4zvn60ws/W9kCX3J8VzI/AAAAAAAAKLw/jj6m7L5DTNgoPucCzelNm_Q5evIhpN5AgCLcBGAs/s1600/LAS%2BTRADICIONES%2BPERUANAS.jpg"),
        ),
      )
  );
}
  ...
  return Container(
      child: ClipRRect(
        ...
        child: Image(
          ...
          height: 500,
          fit: BoxFit.cover,
          image: NetworkImage("https://hubinformacion.continental.edu.pe/sitio/wp-content/uploads/2020/05/portadaObras01.png"),
        ),
      )
  );
}
  ...
  return Container(
      child: ClipRRect(
        ...
        child: Image(
          ...
          height: 500,
          fit: BoxFit.cover,
          image: NetworkImage("https://peru21.pe/resizer/9uMnkt-9e9z8TjAxwlvzY7Ap1Aw=/620x0/smart/filters:format(jpeg):quality(75)/cloudfront-us-east-1.images.arcpublishing.com/elcomercio/CIQ3VNYGAVDO3NPFOIFE4ZQFDM.jpg"),
        ),
      )
  );
}
